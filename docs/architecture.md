...
marcelo-m7/facodi-theme
  -> addons/facodi-theme
  -> technical module: facodi_theme
```

O monorepo guarda o Gitlink de cada submodule, logo cada commit do monorepo define exatamente as versões dos dois addons usadas no build.
